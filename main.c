...
unsigned int kqADC7,kqADC6;
unsigned char demHienthi,phantuECT;
unsigned char ECT,dienapECT;//don vi 0.1V
unsigned char bandoECT[26] ={
    80,100,95,90,86,82,78,75,
    70,64,60,55,50,44,40,20,15,
    10,5,0,0,80,80,80,80,80
    };
//__________________________________________________________________________
...
while (1){
	...
	// Not fault
            ...
            phantuECT = kqADC7/40;
            ECT =bandoECT[phantuECT];
            putsf("ECT = ");gui1byte(ECT); putsf(" *C");
            hienthiLed(16);
        }
        dienapECT = (unsigned long int)kqADC7*50/1023;//don vi 0.1V
        putsf(" U = ");gui1byte_1le(dienapECT); putsf(" V");enter();
    }
